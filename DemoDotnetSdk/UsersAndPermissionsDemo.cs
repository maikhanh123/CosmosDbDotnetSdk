...
{
    public class UsersAndPermissionsDemo
    {
        public static Uri MyDbDatabaseUri =>
            UriFactory.CreateDatabaseUri("FamiliesDb");
        ...
        public async static Task Run()
        {
            ...
            using (var client = new DocumentClient(new Uri(endpoint), masterKey))
            {
                ...
                var sql = "SELECT VALUE c._self FROM c WHERE c.id = 'mystore'"; //only working with collection id is mystore
                ...
                await DeletePermissionAsync(client, alice, alicePerm);
                await DeletePermissionAsync(client, tom, tomPerm);
        ...
        {
            Console.WriteLine();
            Console.WriteLine(">>> View Users in FamiliesDb <<<");
