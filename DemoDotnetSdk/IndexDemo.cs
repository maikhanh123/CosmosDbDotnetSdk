    ...
    public class IndexDemo
    {
        ...
        public async static Task Run()
        {
            ...
            using (var client = new DocumentClient(new Uri(endpoint), masterKey))
            {
                ...
                await ManualIndexingAsync(client);
        ...
        private static async Task ManualIndexingAsync(DocumentClient client)
        {
            Console.WriteLine();
            ...
            var options = new RequestOptions { OfferThroughput = 1000 };
            var collection = await client.CreateDocumentCollectionAsync(MyDbDatabaseUri, collectionDefinition, options);
            var collectionUri = UriFactory.CreateDocumentCollectionUri("FamiliesDb", "manualindexing");
